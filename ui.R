...
shinyUI(fluidPage(title="THPep: a web server for predicting tumor homing peptides", theme=shinytheme("united"),
                  useShinyjs(),
                  navbarPage(strong("THPep"), collapsible = TRUE,
                             titleContent <- HTML("<b>THPep</b>: a web server for predicting tumor homing peptides"),
